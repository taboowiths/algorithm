...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (int i = 1; i <= N; i++) {
//            dijkstra(i, distance);
            int result = dijkstra(i, distance);
...
//        System.out.println(start +  " start -> X " + Arrays.toString(distance));
...
//        System.out.println(start +  " X -> start " + Arrays.toString(distance));
//        System.out.println(distance[start]);
        return result += distance[start];
    }
}
